...
//        }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null && ctx != null) {
            view = View.inflate(ctx, R.layout.view_selectable_grid_item, null);
            LinearLayout container = findView(view, R.id.view_selectable_grid_item_container);
            View.inflate(ctx, getViewItemId(fileType), container);
        }
...
//
    ...
    private void tempPopulate(View view, FileDescriptorItem item) {
        ...
        BrowseThumbnailImageButton fileThumbnail = findView(view, R.id.view_browse_peer_grid_item_file_thumbnail);
...
//        }
        return R.layout.view_browse_thumbnail_peer_grid_item;
    }
    ...
    private static ArrayList<FileListAdapter.FileDescriptorItem> convertFiles(Collection<FileDescriptor> fds) {
        if (fds == null) {
            return new ArrayList<>();
        }

        ArrayList<FileListAdapter.FileDescriptorItem> list = new ArrayList<>(fds.size());
